    ...
    <div className="min-h-screen flex items-center justify-center p-3 sm:p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="heading-md mb-2">Iniciar sesión</h1>
          <p className="text-body">Bienvenido de vuelta a FORMi</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 rounded-xl font-medium flex items-center justify-center gap-3 transition-all duration-300 hover:bg-white/10"
          style={{
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-sm text-gray-400">
            ¿No tienes cuenta?{' '}
            <Link href="/register" className="text-[#19D3E6] hover:underline">
              Regístrate
            </Link>
          </p>
        </div>
